...
import { useGetOrderDetailsQuery } from "../../slices/orderApiSlices.tsx";
import { useDeliverOrderMutation } from "../../slices/orderApiSlices.tsx";
          ...
          {order.orderItems.length === 0 ? (
            ...
            <div>
              ...
              {userInfo && userInfo?.isAdmin && order.isPaid && !order.isDelivered && (
                <div>
                  <Button type="primary" onClick={deliverOrderHandler}>Sifarişi Göndər</Button>
                </div>
              )}
            </div>
          )}
