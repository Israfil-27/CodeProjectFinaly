...
import { Badge, Layout, Menu, Dropdown } from 'antd';
...
const Navbar = () => {
  ...
  const totalItems = cartItems.reduce((total: number, item: any) => total + item.qty, 0);
      ...
      <Menu theme="dark" mode="horizontal" className="nav-menu">
        ...
        <Menu.Item key="2" className="menu-item">
          <Link to="/cart" className="nav-link">
            ...
            Alış-veriş
            {totalItems > 0 && <Badge className="badge" count={totalItems} showZero color="#faad14" />}
          </Link>
        </Menu.Item>
